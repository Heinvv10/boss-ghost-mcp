...
describe('Autonomous Site Explorer', () => {
    ...
    describe('External Link Handling', () => {
      ...
      `);
            ...
            const externalPages = Array.from(result.sitemap.values()).filter(p => p.url.includes('external.com'));
    ...
    describe('BFS Algorithm Verification', () => {
      ...
      `);
            ...
            const page1Entries = Array.from(result.sitemap.keys()).filter(url => url === 'https://example.com/page1');
